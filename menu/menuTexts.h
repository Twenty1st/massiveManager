...
const char* RETURN_TO_MENU = "Для возврата в меню нажмите 'r'.";

void printMainMenu() {
    std::cout << "ГЛАВНОЕ МЕНЮ\n" << std::endl
              << "\t1. Вставить элементы." << std::endl
              << "\t2. Удалить элементы." << std::endl
              << "\t3. Найти элементы." << std::endl
              << "\t4. Сортировать массив." << std::endl
              << "\t5. Вывести массив." << std::endl
              << "\t0. Выход.\n" << std::endl;
}
